...
import "./MyToken9C0293FA.sol";

contract MyToken9C0293FAPreSale {
    MyToken9C0293FA public token;
    ...
    function MyToken9C0293FAPreSale(
        MyToken9C0293FA _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken9C0293FA(_token);
